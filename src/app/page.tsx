        ...
        <section className="py-12 sm:py-20 md:py-28 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-3/5 space-y-6 text-center lg:text-left">
            ...
            <div className="min-h-[2.5rem] sm:min-h-[3rem] flex items-center justify-center lg:justify-start">
              <motion.p
                ...
                className="text-base sm:text-xl md:text-2xl font-bold text-slate-300 flex items-center gap-2 sm:gap-3 font-heading"
              >
          ...
          <div className="w-full lg:w-2/5 flex justify-center">
            <div className="relative group">
              ...
              <div className="absolute -bottom-2 left-0 sm:-left-4 glass-card px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl border border-cyan-500/40 flex items-center gap-2 shadow-xl text-[10px] sm:text-xs font-bold text-cyan-300">
                <FaBrain className="text-cyan-400 text-sm" />
                <span>GIAIC AI Student</span>
              </div>

              <div className="absolute top-4 right-0 sm:-right-4 glass-card px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl border border-indigo-500/40 flex items-center gap-2 shadow-xl text-[10px] sm:text-xs font-bold text-indigo-300">
